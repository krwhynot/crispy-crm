...
| [activities.md](./activities.md) | Activities | Activity logging (13 types), QuickLogActivityDialog, sample workflow states |
| [tasks.md](./tasks.md) | Tasks | Task management, snooze/postpone, TaskCompletionDialog, priority levels |
