...
test.describe("Opportunities Kanban Board", () => {
  ...
  test("should display opportunity cards with key information", async ({ page: _page }) => {
  ...
  test("should drag opportunity card to different stage", async ({ page: _page, isMobile }) => {
