...
VALUES
  ...
  (20, 'The Capital Grille', 'customer', '11111111-0000-0000-0000-000000000001',
   'active', '["312-555-3001"]', '["manager@capitalgrille.com"]', 'https://thecapitalgrille.com',
   '633 N Saint Clair Street', 'Chicago', 'IL', '60611', 'USA', 2,
  ...
  (21, 'Ruth''s Chris Steak House', 'customer', '11111111-0000-0000-0000-000000000001',
   'active', '["504-555-3002"]', '["purchasing@ruthschris.com"]', 'https://ruthschris.com',
   '500 Tchoupitoulas Street', 'New Orleans', 'LA', '70130', 'USA', 2,
  ...
  (22, 'Morton''s The Steakhouse', 'customer', '11111111-0000-0000-0000-000000000001',
   'active', '["312-555-3003"]', '["gm@mortons.com"]', 'https://mortons.com',
   '65 E Wacker Place', 'Chicago', 'IL', '60601', 'USA', 3,
  ...
  (23, 'Chili''s Grill & Bar', 'customer', '11111111-0000-0000-0000-000000000002',
   'active', '["972-555-3004"]', '["procurement@brinker.com"]', 'https://chilis.com',
   '6820 LBJ Freeway', 'Dallas', 'TX', '75240', 'USA', 3,
   'Brinker International casual dining. High volume, value-focused.',
   NOW(), NOW()),

  (24, 'Applebee''s', 'customer', '11111111-0000-0000-0000-000000000002',
   'active', '["913-555-3005"]', '["vendors@applebees.com"]', 'https://applebees.com',
   '8140 Ward Parkway', 'Kansas City', 'MO', '64114', 'USA', 4,
  ...
  (25, 'Buffalo Wild Wings', 'customer', '11111111-0000-0000-0000-000000000002',
   'active', '["612-555-3006"]', '["purchasing@buffalowildwings.com"]', 'https://buffalowildwings.com',
   '5500 Wayzata Blvd', 'Minneapolis', 'MN', '55416', 'USA', 4,
   'Sports bar concept. High sauce and wing volume.',
   NOW(), NOW()),

  (26, 'Red Robin', 'customer', '11111111-0000-0000-0000-000000000002',
   'active', '["303-555-3007"]', '["foodsupply@redrobin.com"]', 'https://redrobin.com',
   '6312 S Fiddlers Green Circle', 'Greenwood Village', 'CO', '80111', 'USA', 5,
   'Gourmet burger casual dining. Bottomless fries concept.',
   NOW(), NOW()),

  -- Fast Casual (3)
  (27, 'Panera Bread', 'customer', '11111111-0000-0000-0000-000000000003',
   'active', '["314-555-3008"]', '["suppliers@panerabread.com"]', 'https://panerabread.com',
   '3630 S Geyer Road', 'St. Louis', 'MO', '63127', 'USA', 5,
  ...
  (28, 'Chipotle Mexican Grill', 'customer', '11111111-0000-0000-0000-000000000003',
   'active', '["949-555-3009"]', '["purchasing@chipotle.com"]', 'https://chipotle.com',
   '610 Newport Center Drive', 'Newport Beach', 'CA', '92660', 'USA', 6,
   'Fast casual Mexican. Food with Integrity sourcing program.',
   NOW(), NOW()),

  (29, 'Shake Shack', 'customer', '11111111-0000-0000-0000-000000000003',
   'active', '["212-555-3010"]', '["supply@shakeshack.com"]', 'https://shakeshack.com',
   '225 Varick Street', 'New York', 'NY', '10014', 'USA', 6,
  ...
  (30, 'Marriott International', 'customer', '11111111-0000-0000-0000-000000000007',
   'active', '["301-555-3011"]', '["foodprocurement@marriott.com"]', 'https://marriott.com',
   '10400 Fernwood Road', 'Bethesda', 'MD', '20817', 'USA', 2,
  ...
  (31, 'Hilton Hotels', 'customer', '11111111-0000-0000-0000-000000000007',
   'active', '["703-555-3012"]', '["purchasing@hilton.com"]', 'https://hilton.com',
   '7930 Jones Branch Drive', 'McLean', 'VA', '22102', 'USA', 3,
   'Global hotel chain. Convention and banquet focus.',
   NOW(), NOW()),

  (32, 'Hyatt Hotels', 'customer', '11111111-0000-0000-0000-000000000007',
   'active', '["312-555-3013"]', '["foodsourcing@hyatt.com"]', 'https://hyatt.com',
   '150 N Riverside Plaza', 'Chicago', 'IL', '60606', 'USA', 3,
   'Upscale hotel chain. Strong restaurant-in-hotel concepts.',
   NOW(), NOW()),

  -- Healthcare (2)
  (33, 'HCA Healthcare', 'customer', '11111111-0000-0000-0000-000000000011',
   'active', '["615-555-3014"]', '["dietary@hcahealthcare.com"]', 'https://hcahealthcare.com',
   'One Park Plaza', 'Nashville', 'TN', '37203', 'USA', 4,
  ...
  (34, 'Ascension Health', 'customer', '11111111-0000-0000-0000-000000000011',
   'active', '["314-555-3015"]', '["nutrition@ascension.org"]', 'https://ascension.org',
   '4600 Edmundson Road', 'St. Louis', 'MO', '63134', 'USA', 4,
  ...
  (35, 'Aramark Higher Education', 'customer', '11111111-0000-0000-0000-000000000013',
   'active', '["215-555-3016"]', '["education@aramark.com"]', 'https://aramark.com',
   '2400 Market Street', 'Philadelphia', 'PA', '19103', 'USA', 5,
  ...
  (36, 'Sodexo Campus Services', 'customer', '11111111-0000-0000-0000-000000000013',
   'active', '["301-555-3017"]', '["campus@sodexo.com"]', 'https://sodexo.com',
   '9801 Washingtonian Blvd', 'Gaithersburg', 'MD', '20878', 'USA', 5,
  ...
  (37, 'Brookdale Senior Living', 'customer', '11111111-0000-0000-0000-000000000015',
   'active', '["615-555-3018"]', '["culinary@brookdale.com"]', 'https://brookdale.com',
   '111 Westwood Place', 'Brentwood', 'TN', '37027', 'USA', 6,
  ...
  (38, 'Sunrise Senior Living', 'customer', '11111111-0000-0000-0000-000000000015',
   'active', '["703-555-3019"]', '["dining@sunriseseniorliving.com"]', 'https://sunriseseniorliving.com',
   '7900 Westpark Drive', 'McLean', 'VA', '22102', 'USA', 6,
  ...
  (39, 'Levy Restaurants', 'customer', '11111111-0000-0000-0000-000000000027',
   'active', '["312-555-3020"]', '["procurement@levyrestaurants.com"]', 'https://levyrestaurants.com',
   '980 N Michigan Avenue', 'Chicago', 'IL', '60611', 'USA', 2,
