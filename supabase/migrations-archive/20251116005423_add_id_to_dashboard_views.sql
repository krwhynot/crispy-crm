-- =====================================================
-- Migration: Add id alias to dashboard views
-- Purpose: Fix React Admin data_provider_error for principal_opportunities and priority_tasks
-- Issue: React Admin requires all resources to have an 'id' field
-- Solution: Add o.id AS id and t.id AS id while retaining semantic *_id columns
-- Date: 2025-11-16
-- =====================================================
