...
-- Step 3: Drop ALL dependent views (7 views reference organization_type)
...
-- Step 8: Recreate all views

-- 8a: authorization_status
...
-- 8b: organizations_with_account_manager
...
-- 8d: dashboard_principal_summary
