...
INSERT INTO segments (id, name, created_at, created_by) VALUES
  ('f05b4ec6-3e1e-5483-9abc-ca7938d56acb', 'Bar/Lounge', NOW(), NULL),
  ('189fa12f-28bb-53fd-a185-60df9b6778f9', 'Breakfast/Brunch', NOW(), NULL),
  ('a6f2f8de-53ef-5173-8757-414beb8bfb79', 'Business and Industry', NOW(), NULL),
  ('87dbea65-b127-5ef5-b451-87757411c1c4', 'Casual Dining', NOW(), NULL),
  ('5cb20587-c143-540d-b242-c761fb4bd731', 'Catering', NOW(), NULL),
  ('a2c94cf2-feac-5238-9102-28a65a3f1581', 'Chain/Group', NOW(), NULL),
  ('e56a409e-abae-5366-b4ea-321cd33c946d', 'Country Clubs/Golf/Health Fitness', NOW(), NULL),
  ('489a3a5c-282e-5665-a28b-b0d51d1a3398', 'Distributor', NOW(), NULL),
  ('86682bb5-521a-5e5a-a0cc-fdae6a3628f3', 'Education', NOW(), NULL),
  ('54a274d9-ab46-5a59-b0d9-31a3999b9687', 'Entertainment', NOW(), NULL),
  ('dd94125f-f297-550c-9fc5-1ab4f156e1cb', 'Ethnic Cuisine', NOW(), NULL),
  ('40f9cec9-9873-5753-a739-28ec534424bc', 'Fast food', NOW(), NULL),
  ('4e25acfd-530e-59a3-b68c-d4e3ec9e2fd4', 'Fine Dining', NOW(), NULL),
  ('6dca7cfa-092c-5539-ac12-a55acec8bbd2', 'Food Truck', NOW(), NULL),
  ('d257be96-640d-5204-a69b-d1101f6a8ea1', 'Gastropub', NOW(), NULL),
  ('ce54d460-e2bd-5205-9286-a8d4f0e5fcc2', 'Healthcare', NOW(), NULL),
  ('205d4566-2414-5e8d-9a10-c3c67d2fab00', 'Hospitality', NOW(), NULL),
  ('06ee08c4-8332-51a4-bfbe-60fc9192088c', 'Industrial', NOW(), NULL),
  ('96fcde9e-03cd-5e6b-8090-f75a3f00a35b', 'Italian', NOW(), NULL),
  ('ef5cdee6-2e42-5d1b-9d09-392e06a53b12', 'Management Company', NOW(), NULL),
  ('a336d0ec-f44a-5b00-bb1b-6a852c11802c', 'Meal Prep Service', NOW(), NULL),
  ('bd94b0d6-4c45-5c71-b19a-451e854486bb', 'Military/Government', NOW(), NULL),
...
773-545-7427'),
  ...
  (1799, 'VAF', 'principal', 'C', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
  (1800, 'Ofk', 'principal', 'C', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
  (1801, 'Annasea', 'principal', 'C', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
  (1802, 'Rapid Rasoi', 'principal', 'C', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
  (1803, 'SWAP', 'principal', 'C', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
  (1804, 'Never Better', 'principal', 'C', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
  (1805, 'TCFB', 'principal', 'C', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
  (1806, 'Mrs Ressler''s', 'principal', 'C', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
  (1807, 'Abdale', 'principal', 'C', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
  (1808, 'Mccrum', 'principal', 'C', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
  (1809, 'Kayco', 'principal', 'C', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
-- TASKS - E2E Test Data
-- ============================================================================
-- Tasks linked to existing opportunities for dashboard quick actions E2E tests
-- Ensures checkboxes appear in Next Action column
