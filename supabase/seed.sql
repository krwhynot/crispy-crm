...
INSERT INTO "public"."products" (
  id, name, category, principal_id, description, sku, status,
  list_price, unit_of_measure, certifications, allergens, ingredients,
  nutritional_info, marketing_description, created_at, updated_at
)
VALUES
  -- McCRUM Products (Principal ID: 1)
  (1, 'Premium Crinkle Cut Fries', 'Frozen Potato', 1, 'Classic crinkle cut fries, Idaho potatoes, 5/16" cut', 'MCR-FRY-001', 'active',
   42.99, 'case (6x5lb)', ARRAY['Kosher', 'Non-GMO Project Verified']::text[], ARRAY[]::text[],
   'Idaho potatoes, vegetable oil (canola and/or sunflower), dextrose, sodium acid pyrophosphate (to maintain natural color)',
   '{"serving_size": "85g", "calories": 130, "total_fat_g": 4, "sodium_mg": 280, "carbs_g": 22, "protein_g": 2}'::jsonb,
   'Premium 100% Idaho potatoes, perfectly cut for consistent cooking and golden color. Ideal for fine dining and casual restaurants seeking superior fry quality.',
   NOW(), NOW()),
  (2, 'Seasoned Wedge Fries', 'Frozen Potato', 1, 'Skin-on potato wedges with seasoning blend', 'MCR-FRY-002', 'active',
   45.99, 'case (6x5lb)', ARRAY['Kosher']::text[], ARRAY[]::text[],
   'Idaho potatoes, vegetable oil (canola and/or sunflower), seasoning blend (salt, spices, garlic powder, onion powder, paprika), dextrose',
   '{"serving_size": "100g", "calories": 150, "total_fat_g": 5, "sodium_mg": 320, "carbs_g": 24, "protein_g": 3}'::jsonb,
   'Rustic skin-on wedges with a savory herb seasoning blend. Perfect for casual dining menus and sports bars seeking a premium upgrade.',
   NOW(), NOW()),
  (3, 'Hash Brown Patties', 'Frozen Potato', 1, 'Formed hash brown patties, 2.25oz each', 'MCR-HB-001', 'active',
   38.99, 'case (72ct)', ARRAY['Non-GMO Project Verified']::text[], ARRAY[]::text[],
   'Potatoes, vegetable oil (contains one or more of the following: canola oil, soybean oil, cottonseed oil), salt, dehydrated onion, pepper',
   '{"serving_size": "64g (1 patty)", "calories": 120, "total_fat_g": 6, "sodium_mg": 230, "carbs_g": 15, "protein_g": 1}'::jsonb,
   'Perfectly formed 2.25oz hash brown patties for consistent breakfast portions. Crispy exterior with fluffy interior every time.',
   NOW(), NOW()),
  (4, 'Diced Potatoes IQF', 'Frozen Potato', 1, '1/2" diced Idaho potatoes, individually quick frozen', 'MCR-DIC-001', 'active',
   35.99, 'case (4x5lb)', ARRAY['Kosher', 'Non-GMO Project Verified']::text[], ARRAY[]::text[],
   'Idaho potatoes, dextrose, sodium acid pyrophosphate (to maintain color)',
   '{"serving_size": "85g", "calories": 70, "total_fat_g": 0, "sodium_mg": 15, "carbs_g": 15, "protein_g": 2}'::jsonb,
   'Versatile 1/2" diced potatoes perfect for breakfast skillets, soups, and loaded dishes. IQF process ensures easy portion control.',
   NOW(), NOW()),

  -- SWAP Products (Principal ID: 2)
  (5, 'Plant-Based Crumbles', 'Plant-Based Protein', 2, 'Soy-free plant protein crumbles for tacos/bowls', 'SWP-PB-001', 'active',
   52.99, 'case (4x2.5lb)', ARRAY['Vegan Certified', 'Non-GMO Project Verified', 'Gluten-Free']::text[], ARRAY['Pea protein']::text[],
   'Water, pea protein, expeller-pressed canola oil, methylcellulose, natural flavor, yeast extract, sea salt, beet powder (for color)',
   '{"serving_size": "85g", "calories": 110, "total_fat_g": 5, "sodium_mg": 380, "carbs_g": 4, "protein_g": 13}'::jsonb,
   'The perfect soy-free meat alternative with authentic texture and 13g protein per serving. Ideal for tacos, bowls, and anywhere ground meat is used.',
   NOW(), NOW()),
  (6, 'Oat Milk Creamer', 'Dairy Alternative', 2, 'Barista-style oat milk, froths perfectly', 'SWP-OAT-001', 'active',
   42.50, 'case (12x32oz)', ARRAY['Vegan Certified', 'Non-GMO Project Verified', 'Kosher']::text[], ARRAY['Oats', 'May contain tree nuts']::text[],
   'Oat base (water, oats), rapeseed oil, dipotassium phosphate, calcium carbonate, tricalcium phosphate, sea salt, gellan gum',
   '{"serving_size": "240ml", "calories": 120, "total_fat_g": 5, "sodium_mg": 100, "carbs_g": 16, "protein_g": 3}'::jsonb,
   'Barista-approved oat milk that froths like dairy. Neutral taste profile and creamy texture perfect for specialty coffee programs.',
   NOW(), NOW()),
  (7, 'Cauliflower Rice', 'Vegetable', 2, 'Riced cauliflower, ready to heat', 'SWP-VEG-001', 'active',
   36.99, 'case (6x2lb)', ARRAY['Vegan Certified', 'Non-GMO Project Verified', 'Gluten-Free', 'Keto-Friendly']::text[], ARRAY[]::text[],
   'Cauliflower',
   '{"serving_size": "85g", "calories": 20, "total_fat_g": 0, "sodium_mg": 15, "carbs_g": 4, "protein_g": 2, "fiber_g": 2}'::jsonb,
   'Clean-label cauliflower rice with just one ingredient. Perfect base for low-carb and keto menu options.',
   NOW(), NOW()),
  (8, 'Jackfruit Pulled Pork Style', 'Plant-Based Protein', 2, 'Seasoned young jackfruit, BBQ ready', 'SWP-PB-002', 'active',
   48.99, 'case (6x2lb)', ARRAY['Vegan Certified', 'Non-GMO Project Verified', 'Gluten-Free']::text[], ARRAY[]::text[],
   'Young jackfruit, water, organic cane sugar, sea salt, citric acid',
   '{"serving_size": "100g", "calories": 35, "total_fat_g": 0, "sodium_mg": 180, "carbs_g": 9, "protein_g": 1}'::jsonb,
   'Naturally shredded young jackfruit with pulled pork texture. Perfect for BBQ sandwiches, tacos, and plant-forward menu items.',
   NOW(), NOW()),

  -- Rapid Rasoi Products (Principal ID: 3)
  (9, 'Garlic Naan', 'Bread', 3, 'Traditional Indian garlic naan, par-baked', 'RR-NAAN-001', 'active',
   28.99, 'case (120ct)', ARRAY['Halal Certified']::text[], ARRAY['Wheat', 'Milk', 'Eggs']::text[],
   'Enriched wheat flour, water, yogurt, ghee, garlic, yeast, sugar, salt, cilantro',
   '{"serving_size": "1 piece (50g)", "calories": 140, "total_fat_g": 3, "sodium_mg": 260, "carbs_g": 24, "protein_g": 4}'::jsonb,
   'Authentic tandoor-style garlic naan, par-baked for quick finishing. Traditional recipe with real ghee and fresh garlic.',
   NOW(), NOW()),
  (10, 'Butter Chicken Sauce', 'Sauce', 3, 'Authentic makhani sauce, heat and serve', 'RR-SAU-001', 'active',
   55.99, 'case (4x1gal)', ARRAY['Halal Certified', 'Gluten-Free']::text[], ARRAY['Milk', 'Tree nuts (cashew)']::text[],
   'Tomato puree, cream, butter, cashews, ginger, garlic, garam masala, kashmiri chili, fenugreek leaves, salt, sugar',
   '{"serving_size": "120ml", "calories": 180, "total_fat_g": 14, "sodium_mg": 520, "carbs_g": 10, "protein_g": 3}'::jsonb,
   'Rich and creamy butter chicken sauce using traditional makhani recipe. Just add protein for an authentic Indian entree.',
   NOW(), NOW()),
  (11, 'Samosa (Vegetable)', 'Appetizer', 3, 'Crispy vegetable samosas, frozen', 'RR-APP-001', 'active',
   44.99, 'case (100ct)', ARRAY['Halal Certified', 'Vegetarian']::text[], ARRAY['Wheat']::text[],
   'Filling: potatoes, peas, onions, cumin, coriander, garam masala, green chilies, salt. Pastry: wheat flour, vegetable oil, salt, carom seeds',
   '{"serving_size": "1 piece (60g)", "calories": 120, "total_fat_g": 5, "sodium_mg": 210, "carbs_g": 16, "protein_g": 3}'::jsonb,
   'Traditional vegetable samosas with spiced potato and pea filling. Crispy pastry shell perfect as appetizers or shareables.',
   NOW(), NOW()),
  (12, 'Basmati Rice Pilaf', 'Rice', 3, 'Seasoned basmati rice with whole spices', 'RR-RICE-001', 'active',
   38.99, 'case (6x5lb)', ARRAY['Halal Certified', 'Vegan', 'Gluten-Free']::text[], ARRAY[]::text[],
   'Aged basmati rice, vegetable oil, whole cumin, cardamom, bay leaves, cinnamon, salt',
   '{"serving_size": "150g cooked", "calories": 190, "total_fat_g": 2, "sodium_mg": 280, "carbs_g": 38, "protein_g": 4}'::jsonb,
   'Aged basmati rice cooked with aromatic whole spices for authentic Indian flavor. Ready to heat and serve.',
   NOW(), NOW()),

  -- Lakeview Farms Products (Principal ID: 4)
  (13, 'French Onion Dip', 'Dip', 4, 'Creamy French onion dip, 5lb tub', 'LVF-DIP-001', 'active',
   24.99, 'tub (5lb)', ARRAY['Kosher']::text[], ARRAY['Milk', 'Soy']::text[],
   'Sour cream, onion, salt, sugar, monosodium glutamate, onion powder, spices, citric acid, caramel color',
   '{"serving_size": "30g", "calories": 60, "total_fat_g": 5, "sodium_mg": 160, "carbs_g": 3, "protein_g": 1}'::jsonb,
   'Classic creamy French onion dip made with real sour cream. Perfect for chips, vegetables, and appetizer platters.',
   NOW(), NOW()),
  (14, 'Fruit Parfait Cup', 'Dessert', 4, 'Layered yogurt parfait with granola', 'LVF-DES-001', 'active',
   72.99, 'case (48ct)', ARRAY['Kosher']::text[], ARRAY['Milk', 'Wheat', 'Tree nuts']::text[],
   'Vanilla yogurt, seasonal fruit, honey granola with almonds',
   '{"serving_size": "1 cup (170g)", "calories": 220, "total_fat_g": 4, "sodium_mg": 95, "carbs_g": 38, "protein_g": 8}'::jsonb,
   'Grab-and-go parfaits layered with creamy vanilla yogurt, fresh fruit, and crunchy honey granola. Perfect for campus retail.',
   NOW(), NOW()),
  (15, 'Spinach Artichoke Dip', 'Dip', 4, 'Premium spinach artichoke dip', 'LVF-DIP-002', 'active',
   32.99, 'tub (5lb)', ARRAY['Kosher', 'Vegetarian']::text[], ARRAY['Milk', 'Soy']::text[],
   'Cream cheese, sour cream, parmesan cheese, spinach, artichoke hearts, garlic, spices',
   '{"serving_size": "30g", "calories": 70, "total_fat_g": 6, "sodium_mg": 140, "carbs_g": 2, "protein_g": 2}'::jsonb,
   'Restaurant-quality spinach artichoke dip with real parmesan and cream cheese. Heat and serve for premium appetizers.',
   NOW(), NOW()),
  (16, 'Cheesecake Slice', 'Dessert', 4, 'New York style cheesecake, pre-sliced', 'LVF-DES-002', 'active',
   89.99, 'case (48 slices)', ARRAY['Kosher']::text[], ARRAY['Milk', 'Wheat', 'Eggs']::text[],
   'Cream cheese, sugar, eggs, sour cream, vanilla, graham cracker crust (wheat flour, sugar, palm oil)',
   '{"serving_size": "1 slice (100g)", "calories": 320, "total_fat_g": 21, "sodium_mg": 240, "carbs_g": 28, "protein_g": 6}'::jsonb,
   'Classic New York-style cheesecake pre-sliced for portion control. Dense, creamy texture with graham cracker crust.',
   NOW(), NOW()),

  -- Frico Products (Principal ID: 5)
  (17, 'Aged Parmesan Wheel', 'Cheese', 5, '24-month aged Parmigiano-Reggiano', 'FRC-CHE-001', 'active',
   849.99, 'wheel (80lb)', ARRAY['DOP Certified', 'Non-GMO']::text[], ARRAY['Milk']::text[],
   'Raw cow milk, salt, rennet',
   '{"serving_size": "28g", "calories": 110, "total_fat_g": 7, "sodium_mg": 330, "carbs_g": 1, "protein_g": 10}'::jsonb,
   'Authentic Parmigiano-Reggiano DOP aged minimum 24 months. Perfect for tableside presentations and premium applications.',
   NOW(), NOW()),
  (18, 'Gorgonzola Crumbles', 'Cheese', 5, 'Italian Gorgonzola, crumbled for salads', 'FRC-CHE-002', 'active',
   58.99, 'tub (5lb)', ARRAY['DOP Certified']::text[], ARRAY['Milk']::text[],
   'Pasteurized cow milk, salt, rennet, penicillium roqueforti',
   '{"serving_size": "28g", "calories": 100, "total_fat_g": 9, "sodium_mg": 380, "carbs_g": 0, "protein_g": 6}'::jsonb,
   'Authentic Italian Gorgonzola DOP, hand-crumbled for salads and premium applications. Rich, tangy flavor with creamy texture.',
   NOW(), NOW()),
  (19, 'Asiago Fresco', 'Cheese', 5, 'Young Asiago cheese, mild and creamy', 'FRC-CHE-003', 'active',
   42.99, 'wheel (12lb)', ARRAY['DOP Certified']::text[], ARRAY['Milk']::text[],
   'Pasteurized cow milk, salt, rennet',
   '{"serving_size": "28g", "calories": 100, "total_fat_g": 8, "sodium_mg": 260, "carbs_g": 1, "protein_g": 7}'::jsonb,
   'Young Asiago with mild, buttery flavor. Versatile cheese perfect for melting, slicing, or grating.',
   NOW(), NOW()),
  (20, 'Shaved Parmesan', 'Cheese', 5, 'Pre-shaved Parmesan for finishing', 'FRC-CHE-004', 'active',
   62.99, 'tub (5lb)', ARRAY['Non-GMO']::text[], ARRAY['Milk']::text[],
   'Pasteurized cow milk, cheese cultures, salt, enzymes',
   '{"serving_size": "28g", "calories": 110, "total_fat_g": 7, "sodium_mg": 310, "carbs_g": 1, "protein_g": 10}'::jsonb,
   'Delicate pre-shaved Parmesan for elegant finishing. Perfect for salads, pasta, and tableside service.',
   NOW(), NOW()),

  -- Anchor Products (Principal ID: 6)
  (21, 'Professional Butter', 'Dairy', 6, 'New Zealand grass-fed butter, 82% fat', 'ANC-DAI-001', 'active',
   168.99, 'case (36x1lb)', ARRAY['Grass-Fed Certified', 'Non-GMO']::text[], ARRAY['Milk']::text[],
   'Pasteurized cream (from grass-fed cows), natural flavor',
   '{"serving_size": "14g", "calories": 100, "total_fat_g": 11, "sodium_mg": 0, "carbs_g": 0, "protein_g": 0}'::jsonb,
   'Premium 82% butterfat from New Zealand grass-fed cows. Superior flavor and higher smoke point for professional kitchens.',
   NOW(), NOW()),
  (22, 'Extra Thick Cream', 'Dairy', 6, 'Heavy cream for whipping, 40% fat', 'ANC-DAI-002', 'active',
   89.99, 'case (12x1qt)', ARRAY['Grass-Fed Certified']::text[], ARRAY['Milk']::text[],
   'Grade A pasteurized cream',
   '{"serving_size": "30ml", "calories": 110, "total_fat_g": 11, "sodium_mg": 10, "carbs_g": 1, "protein_g": 1}'::jsonb,
   'Extra-thick 40% fat cream that whips to perfect peaks. Ideal for desserts, sauces, and finishing dishes.',
   NOW(), NOW()),
  (23, 'UHT Cream Portions', 'Dairy', 6, 'Shelf-stable cream portions for coffee', 'ANC-DAI-003', 'active',
   45.99, 'case (360ct)', ARRAY['Kosher']::text[], ARRAY['Milk']::text[],
   'Cream, carrageenan',
   '{"serving_size": "11ml", "calories": 35, "total_fat_g": 3.5, "sodium_mg": 5, "carbs_g": 0, "protein_g": 0}'::jsonb,
   'Shelf-stable cream portions perfect for room service, patient trays, and coffee service. No refrigeration needed until opened.',
   NOW(), NOW()),
  (24, 'Clarified Butter', 'Dairy', 6, 'Ghee-style clarified butter for high-heat cooking', 'ANC-DAI-004', 'active',
   124.99, 'case (6x5lb)', ARRAY['Grass-Fed Certified', 'Kosher']::text[], ARRAY['Milk']::text[],
   'Clarified butter (from grass-fed cow cream)',
   '{"serving_size": "14g", "calories": 130, "total_fat_g": 15, "sodium_mg": 0, "carbs_g": 0, "protein_g": 0}'::jsonb,
   'Pure clarified butter with 485°F smoke point. Perfect for searing steaks and high-heat cooking applications.',
   NOW(), NOW()),

  -- Tattooed Chef Products (Principal ID: 7)
  (25, 'Plant-Based Buddha Bowl', 'Frozen Entree', 7, 'Complete vegan meal bowl, quinoa base', 'TC-ENT-001', 'active',
   72.99, 'case (12ct)', ARRAY['Vegan Certified', 'Non-GMO Project Verified', 'Gluten-Free']::text[], ARRAY['Coconut']::text[],
   'Quinoa, roasted sweet potato, chickpeas, kale, tahini dressing, turmeric',
   '{"serving_size": "1 bowl (300g)", "calories": 340, "total_fat_g": 12, "sodium_mg": 480, "carbs_g": 48, "protein_g": 12}'::jsonb,
   'Complete plant-based meal bowl with protein-rich quinoa and roasted vegetables. Microwave-ready for quick healthy meals.',
   NOW(), NOW()),
  (26, 'Cauliflower Mac', 'Frozen Entree', 7, 'Plant-based mac and cheese alternative', 'TC-ENT-002', 'active',
   68.99, 'case (12ct)', ARRAY['Vegan Certified', 'Non-GMO Project Verified']::text[], ARRAY['Coconut', 'Tree nuts (cashew)']::text[],
   'Cauliflower, cashew cream sauce, nutritional yeast, pasta (rice flour, quinoa flour), turmeric',
   '{"serving_size": "1 bowl (255g)", "calories": 280, "total_fat_g": 14, "sodium_mg": 520, "carbs_g": 32, "protein_g": 8}'::jsonb,
   'Creamy plant-based mac made with cauliflower and cashew cream. Comfort food without the dairy.',
   NOW(), NOW()),
  (27, 'Veggie Burrito', 'Frozen Entree', 7, 'Bean and vegetable burrito, vegan', 'TC-ENT-003', 'active',
   64.99, 'case (24ct)', ARRAY['Vegan Certified', 'Non-GMO Project Verified']::text[], ARRAY['Wheat']::text[],
   'Flour tortilla, black beans, brown rice, roasted peppers, onions, tomatoes, cumin, chili powder',
   '{"serving_size": "1 burrito (170g)", "calories": 290, "total_fat_g": 6, "sodium_mg": 540, "carbs_g": 48, "protein_g": 10}'::jsonb,
   'Hearty vegan burrito packed with black beans, rice, and roasted vegetables. Perfect grab-and-go option.',
   NOW(), NOW()),
  (28, 'Acai Bowl', 'Frozen Dessert', 7, 'Ready-to-serve acai bowl with toppings', 'TC-DES-001', 'active',
   78.99, 'case (12ct)', ARRAY['Vegan Certified', 'Non-GMO Project Verified', 'Gluten-Free']::text[], ARRAY['Coconut', 'Tree nuts']::text[],
   'Acai puree, banana, coconut milk, granola topping, chia seeds, coconut flakes',
   '{"serving_size": "1 bowl (200g)", "calories": 260, "total_fat_g": 10, "sodium_mg": 45, "carbs_g": 38, "protein_g": 5}'::jsonb,
   'Superfood acai bowl ready to serve with granola topping. Trendy, Instagram-worthy healthy dessert option.',
   NOW(), NOW()),

  -- Litehouse Products (Principal ID: 8)
  (29, 'Chunky Blue Cheese', 'Dressing', 8, 'Premium blue cheese dressing with chunks', 'LH-DRS-001', 'active',
   52.99, 'case (4x1gal)', ARRAY['Kosher', 'Gluten-Free']::text[], ARRAY['Milk', 'Eggs']::text[],
   'Soybean oil, blue cheese crumbles (milk, cheese cultures, salt, enzymes), water, egg yolk, vinegar, sugar, salt, spices, xanthan gum',
   '{"serving_size": "30g", "calories": 160, "total_fat_g": 16, "sodium_mg": 270, "carbs_g": 1, "protein_g": 1}'::jsonb,
   'Premium blue cheese dressing loaded with real blue cheese chunks. Bold tangy flavor perfect for wings and salads.',
   NOW(), NOW()),
  (30, 'Homestyle Ranch', 'Dressing', 8, 'Classic buttermilk ranch dressing', 'LH-DRS-002', 'active',
   48.99, 'case (4x1gal)', ARRAY['Kosher', 'Gluten-Free']::text[], ARRAY['Milk', 'Eggs']::text[],
   'Soybean oil, buttermilk, water, egg yolk, vinegar, sugar, salt, garlic, onion, spices, xanthan gum',
   '{"serving_size": "30g", "calories": 140, "total_fat_g": 14, "sodium_mg": 240, "carbs_g": 2, "protein_g": 0}'::jsonb,
   'Classic buttermilk ranch with real buttermilk and herbs. America''s favorite dressing for salads and dipping.',
   NOW(), NOW()),
  (31, 'Caesar Dressing', 'Dressing', 8, 'Traditional Caesar with anchovy', 'LH-DRS-003', 'active',
   54.99, 'case (4x1gal)', ARRAY['Kosher']::text[], ARRAY['Milk', 'Eggs', 'Fish (anchovy)']::text[],
   'Soybean oil, water, parmesan cheese, egg yolk, anchovy paste, garlic, lemon juice, worcestershire sauce, salt, black pepper',
   '{"serving_size": "30g", "calories": 150, "total_fat_g": 15, "sodium_mg": 310, "carbs_g": 1, "protein_g": 1}'::jsonb,
   'Authentic Caesar dressing with real Parmesan and anchovy. Bold, savory flavor for classic Caesar salads.',
   NOW(), NOW()),
  (32, 'Freeze-Dried Herbs', 'Seasoning', 8, 'Assorted freeze-dried herbs for finishing', 'LH-HRB-001', 'active',
   35.99, 'jar (2oz)', ARRAY['Kosher', 'Vegan', 'Non-GMO Project Verified']::text[], ARRAY[]::text[],
   'Freeze-dried chives, parsley, basil, oregano',
   '{"serving_size": "1g", "calories": 3, "total_fat_g": 0, "sodium_mg": 0, "carbs_g": 0, "protein_g": 0}'::jsonb,
   'Premium freeze-dried herbs retaining fresh flavor and vibrant color. Perfect for finishing dishes with restaurant-quality presentation.',
   NOW(), NOW()),

  -- Custom Culinary Products (Principal ID: 9)
  (33, 'Gold Label Chicken Base', 'Base', 9, 'Premium chicken base, no MSG', 'CC-BAS-001', 'active',
   65.99, 'case (6x1lb)', ARRAY['Kosher', 'Gluten-Free', 'No MSG Added']::text[], ARRAY[]::text[],
   'Chicken meat, chicken fat, salt, sugar, corn syrup solids, onion powder, turmeric, natural flavor',
   '{"serving_size": "7g", "calories": 15, "total_fat_g": 1, "sodium_mg": 960, "carbs_g": 1, "protein_g": 1}'::jsonb,
   'Chef-quality chicken base made with real roasted chicken. Creates rich, full-bodied stock with clean label appeal.',
   NOW(), NOW()),
  (34, 'Demi-Glace Concentrate', 'Sauce', 9, 'Classic French demi-glace, concentrated', 'CC-SAU-001', 'active',
   89.99, 'case (6x16oz)', ARRAY['Gluten-Free']::text[], ARRAY[]::text[],
   'Beef stock, tomato paste, red wine, caramelized sugar, onion, carrot, celery, herbs, spices',
   '{"serving_size": "30g", "calories": 25, "total_fat_g": 1, "sodium_mg": 480, "carbs_g": 4, "protein_g": 1}'::jsonb,
   'Classic French demi-glace in concentrated form. Simply dilute for restaurant-quality brown sauce in minutes.',
   NOW(), NOW()),
  (35, 'Roasted Garlic Base', 'Base', 9, 'Roasted garlic flavor base for soups/sauces', 'CC-BAS-002', 'active',
   58.99, 'case (6x1lb)', ARRAY['Kosher', 'Vegan', 'Gluten-Free']::text[], ARRAY[]::text[],
   'Roasted garlic, salt, maltodextrin, sugar, onion powder, natural flavor',
   '{"serving_size": "7g", "calories": 10, "total_fat_g": 0, "sodium_mg": 880, "carbs_g": 2, "protein_g": 0}'::jsonb,
   'Concentrated roasted garlic flavor for soups, sauces, and marinades. One teaspoon equals 5 cloves of roasted garlic.',
   NOW(), NOW()),
  (36, 'Hollandaise Sauce Mix', 'Sauce', 9, 'Just-add-butter hollandaise mix', 'CC-SAU-002', 'active',
   42.99, 'case (6x24oz)', ARRAY['Kosher']::text[], ARRAY['Milk', 'Eggs']::text[],
   'Modified food starch, nonfat dry milk, egg yolk, salt, lemon juice solids, citric acid, natural butter flavor, annatto color',
   '{"serving_size": "60ml prepared", "calories": 90, "total_fat_g": 9, "sodium_mg": 240, "carbs_g": 2, "protein_g": 1}'::jsonb,
   'Restaurant-quality hollandaise in minutes. Just add butter and water for consistent, smooth sauce every time.',
   NOW(), NOW());
...
VALUES
  ...
  -- ========================================
  -- Opp 25: customer_org 20 -> contacts 39, 40
  (61, 'interaction', 'Follow-up', 'Post-demo follow-up', 'Checked in after demo', NOW() - INTERVAL '3 days', 15, 40, 20, 25, true,
  ...
  -- Opp 26: customer_org 22 -> contacts 43, 44
  (62, 'interaction', 'Follow-up', 'Proposal follow-up', 'Followed up on submitted proposal', NOW() - INTERVAL '8 days', 20, 44, 22, 26, false,
  ...
  -- Opp 27: customer_org 25 -> contacts 49, 50
  (63, 'interaction', 'Follow-up', 'Sample feedback follow-up', 'Gathered feedback on samples', NOW() - INTERVAL '12 days', 25, 50, 25, 27, true,
  ...
  -- Opp 28: customer_org 21 -> contacts 41, 42
  (64, 'interaction', 'Follow-up', 'Meeting recap follow-up', 'Confirmed next steps', NOW() - INTERVAL '16 days', 15, 42, 21, 28, false,
  ...
  -- Opp 29: customer_org 10 -> contacts 19, 20
  (65, 'interaction', 'Follow-up', 'Decision timeline follow-up', 'Checked on decision progress', NOW() - INTERVAL '20 days', 20, 19, 10, 29, true,
  ...
  -- Opp 30: customer_org 11 -> contacts 21, 22
  (66, 'interaction', 'Follow-up', 'Contract review follow-up', 'Checked on legal review status', NOW() - INTERVAL '24 days', 15, 21, 11, 30, false,
  ...
  -- Opp 31: customer_org 13 -> contacts 25, 26
  (67, 'interaction', 'Follow-up', 'Budget approval follow-up', 'Inquired about budget status', NOW() - INTERVAL '28 days', 20, 25, 13, 31, true,
  ...
  -- Opp 32: customer_org 31 -> contacts 62, 63
  (68, 'interaction', 'Follow-up', 'Trial results follow-up', 'Discussed pilot outcomes', NOW() - INTERVAL '32 days', 30, 63, 31, 32, false,
  ...
  -- Opp 33: customer_org 18 -> contacts 35, 36
  (69, 'interaction', 'Follow-up', 'Competitive update follow-up', 'Checked on competitive situation', NOW() - INTERVAL '36 days', 25, 35, 18, 33, true,
  ...
  -- Opp 34: customer_org 19 -> contacts 37, 38
  (70, 'interaction', 'Follow-up', 'Menu launch follow-up', 'Checked on menu roll-out', NOW() - INTERVAL '40 days', 20, 38, 19, 34, false,
  ...
  -- Opp 35: customer_org 12 -> contacts 23, 24
  (71, 'interaction', 'Follow-up', 'Stakeholder alignment follow-up', 'Confirmed internal alignment', NOW() - INTERVAL '44 days', 25, 23, 12, 35, true,
  ...
  -- Opp 36: customer_org 15 -> contacts 29, 30
  (72, 'interaction', 'Follow-up', 'Executive decision follow-up', 'Followed up with decision maker', NOW() - INTERVAL '48 days', 30, 29, 15, 36, false,
...
VALUES
  ...
  (4, 'Review contract redlines from legal',
   ...
   CURRENT_DATE - INTERVAL '2 days', CURRENT_DATE - INTERVAL '3 days', 76, 4, 4, false, 'critical', 'admin',
   NOW() - INTERVAL '5 days', NOW()),
  ...
  (6, 'Submit sample request form',
   ...
   CURRENT_DATE - INTERVAL '6 days', CURRENT_DATE - INTERVAL '7 days', 41, 6, 5, false, 'medium', 'admin',
   NOW() - INTERVAL '12 days', NOW()),
  (7, 'Prepare presentation for committee',
   ...
   CURRENT_DATE - INTERVAL '1 day', CURRENT_DATE - INTERVAL '2 days', 66, 7, 6, false, 'critical', 'admin',
   NOW() - INTERVAL '7 days', NOW()),
  ...
  (9, 'Coordinate shipping logistics',
   ...
   CURRENT_DATE - INTERVAL '3 days', CURRENT_DATE - INTERVAL '4 days', 57, 9, 3, false, 'high', 'admin',
   NOW() - INTERVAL '6 days', NOW()),
  ...
  (13, 'Submit distributor application',
   ...
   CURRENT_DATE, CURRENT_DATE - INTERVAL '1 day', 55, 13, 5, false, 'high', 'admin',
   NOW() - INTERVAL '5 days', NOW()),
  (14, 'Review feedback survey results',
   ...
   CURRENT_DATE, CURRENT_DATE - INTERVAL '1 day', 51, 14, 5, false, 'medium', 'admin',
   NOW() - INTERVAL '2 days', NOW()),
  ...
  (18, 'Update CRM with call notes',
   ...
   CURRENT_DATE, CURRENT_DATE, 74, 18, 4, false, 'low', 'admin',
   NOW() - INTERVAL '1 day', NOW()),
  ...
  (21, 'Prepare pricing comparison',
   ...
   CURRENT_DATE + INTERVAL '1 day', CURRENT_DATE, 60, 21, 6, false, 'high', 'admin',
   NOW() - INTERVAL '4 days', NOW()),
  ...
  (24, 'Review pilot results data',
   ...
   CURRENT_DATE + INTERVAL '1 day', CURRENT_DATE, 79, 24, 3, false, 'high', 'admin',
   NOW() - INTERVAL '3 days', NOW()),
  ...
  (26, 'Prepare for trade show',
   ...
   CURRENT_DATE + INTERVAL '3 days', CURRENT_DATE + INTERVAL '2 days', 44, 26, 4, false, 'high', 'admin',
   NOW() - INTERVAL '5 days', NOW()),
  ...
  (28, 'Update opportunity stage',
   ...
   CURRENT_DATE + INTERVAL '4 days', CURRENT_DATE + INTERVAL '3 days', 42, 28, 6, false, 'low', 'admin',
   NOW() - INTERVAL '2 days', NOW()),
  ...
  (30, 'Prepare product samples',
   ...
   CURRENT_DATE + INTERVAL '5 days', CURRENT_DATE + INTERVAL '4 days', 21, 30, 2, false, 'medium', 'admin',
   NOW() - INTERVAL '3 days', NOW()),
  (31, 'Review distributor agreement',
   'Review draft distribution agreement from GFS legal. Note any concerns for discussion.',
   CURRENT_DATE + INTERVAL '2 days', CURRENT_DATE + INTERVAL '1 day', 25, 31, 3, false, 'high', 'admin',
   NOW() - INTERVAL '1 day', NOW()),
  ...
  (38, 'Site visit preparation',
   ...
   CURRENT_DATE + INTERVAL '12 days', CURRENT_DATE + INTERVAL '11 days', 53, 38, 3, false, 'medium', 'admin',
   NOW() - INTERVAL '6 days', NOW()),
  (39, 'Distributor show prep',
   ...
   CURRENT_DATE + INTERVAL '14 days', CURRENT_DATE + INTERVAL '13 days', 71, 39, 4, false, 'high', 'admin',
   NOW() - INTERVAL '10 days', NOW()),
