...
VALUES
  ...
  (44, 'McCRUM - Chipotle National', 1, 28, 17, 2, 2,
   'closed_lost', 'lost', 'high', ARRAY[56]::bigint[], CURRENT_DATE - INTERVAL '30 days',
  ...
  (45, 'SWAP - BWW Pilot', 2, 25, 13, 3, 3,
   'closed_lost', 'lost', 'medium', ARRAY[49]::bigint[], CURRENT_DATE - INTERVAL '45 days',
  ...
  (46, 'Rapid Rasoi - Red Robin', 3, 26, 13, 3, 3,
   'closed_lost', 'lost', 'medium', ARRAY[52]::bigint[], CURRENT_DATE - INTERVAL '20 days',
  ...
  (47, 'Lakeview - Shake Shack', 4, 29, 19, 4, 4,
   'closed_lost', 'lost', 'medium', ARRAY[57]::bigint[], CURRENT_DATE - INTERVAL '35 days',
  ...
  (48, 'Tattooed Chef - Marriott', 7, 30, 12, 5, 5,
   'closed_lost', 'lost', 'medium', ARRAY[61]::bigint[], CURRENT_DATE - INTERVAL '40 days',
  ...
  (49, 'Litehouse - Hyatt National', 8, 32, 12, 5, 5,
   'closed_lost', 'lost', 'high', ARRAY[65]::bigint[], CURRENT_DATE - INTERVAL '15 days',
  ...
  (50, 'Custom Culinary - Brookdale', 9, 37, 13, 6, 6,
   'closed_lost', 'lost', 'medium', ARRAY[75]::bigint[], CURRENT_DATE - INTERVAL '50 days',
  ...
  (51, 'Litehouse Dressings - Stale Deal', 8, 24, 11, 5, 5,
   'sample_visit_offered', 'stale', 'low', ARRAY[47]::bigint[], CURRENT_DATE + INTERVAL '30 days',
   ...
   ARRAY['casual-dining', 'dressings', 'stale']::text[], 'cold_call',
  ...
  (54, 'Frico Cheese - Ancient Deal', 5, 34, 18, 4, 4,
   'new_lead', 'stale', 'low', ARRAY[68]::bigint[], CURRENT_DATE + INTERVAL '90 days',
   ...
   ARRAY['healthcare', 'italian', 'stale']::text[], 'trade_show',
   NOW() - INTERVAL '180 days', NOW() - INTERVAL '30 days'),
...
VALUES
  ...
  (1, 'Follow up on sample delivery confirmation',
   ...
   CURRENT_DATE - INTERVAL '5 days', CURRENT_DATE - INTERVAL '6 days', 39, 1, 2, false, 'high', 'follow_up',
   NOW() - INTERVAL '10 days', NOW()),
  ...
  (10, 'Follow up on budget approval',
   ...
   CURRENT_DATE - INTERVAL '5 days', CURRENT_DATE - INTERVAL '6 days', 49, 10, 3, false, 'medium', 'follow_up',
   NOW() - INTERVAL '10 days', NOW()),
