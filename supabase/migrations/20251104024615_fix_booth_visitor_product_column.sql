-- Fix product_id column reference in create_booth_visitor_opportunity function
-- The column is named product_id_reference, not product_id
...
BEGIN
  ...
  -- Link products if provided (FIXED: use product_id_reference instead of product_id)
