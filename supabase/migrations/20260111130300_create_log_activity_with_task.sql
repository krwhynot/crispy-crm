-- ============================================================================
-- Migration: Create transactional RPC for atomic activity + task creation
-- ============================================================================
-- Audit Issue: WG-001 - Non-atomic activity+task creation in QuickLogForm
-- Pattern: plpgsql function for transactional operations per Supabase best practices
-- Usage: supabase.rpc('log_activity_with_task', { p_activity: {...}, p_task: {...} })
-- ============================================================================
...
Example:
  SELECT log_activity_with_task(
    ''{"activity_type": "engagement", "type": "call", "subject": "Follow-up call", "organization_id": 123}''::jsonb,
