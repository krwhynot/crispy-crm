...
if (!supabaseServiceKey) {
  ...
  console.error('   Get it from: https://supabase.com/dashboard/project/aaqnanddcqvfiwhshndl/settings/api');
  process.exit(1);
}
...
async function executeImport() {
  try {
    ...
    console.log('   - Check that organizations, contacts, opportunities, and activities were created');
