...
async function main() {
  ...
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  console.log(`   Admin:    ${dataVolumes.admin.contacts} contacts, ${dataVolumes.admin.orgs} orgs, ${dataVolumes.admin.opportunities} opportunities, ${dataVolumes.admin.activities} activities`);
  console.log(`   Director:  ${dataVolumes.director.contacts} contacts, ${dataVolumes.director.orgs} orgs, ${dataVolumes.director.opportunities} opportunities, ${dataVolumes.director.activities} activities`);
  console.log(`   Manager:   ${dataVolumes.manager.contacts} contacts, ${dataVolumes.manager.orgs} orgs, ${dataVolumes.manager.opportunities} opportunities, ${dataVolumes.manager.activities} activities`);
  console.log('');
