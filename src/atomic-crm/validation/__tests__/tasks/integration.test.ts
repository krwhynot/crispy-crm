...
describe("Task API Boundary Integration", () => {
  ...
  it("should pass dates through without transformation", () => {
    ...
    // Dates pass through as-is (no transformation per Constitution)
    expect(result.due_date).toBe("2024-12-31T15:30:45.123Z");
    expect(result.completed_at).toBe("2024-12-20T18:45:30.456Z");
  });
});
