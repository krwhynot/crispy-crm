...
describe("OperatorSegments .max() Constraints", () => {
  ...
  describe("updateOperatorSegmentSchema", () => {
    it("should enforce max constraints on partial updates", () => {
      const validUpdate = {
        id: "33333333-3333-4333-8333-000000000001",
        name: "Casual Dining", // Must be valid operator segment name
      };
      expect(() => updateOperatorSegmentSchema.parse(validUpdate)).not.toThrow();
    });
  });
