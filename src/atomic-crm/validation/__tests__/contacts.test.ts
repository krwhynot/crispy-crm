...
describe('Contact Validation Schemas', () => {
  ...
  describe('createContactSchema', () => {
    ...
    it('should reject creation without required fields', () => {
      ...
      expect(() => createContactSchema.parse({ first_name: 'John' })).toThrow(z.ZodError);
  ...
  describe('updateContactSchema', () => {
    ...
    it('should reject updates without id', () => {
      ...
      expect(() => updateContactSchema.parse(invalidUpdate)).toThrow(z.ZodError);
    });

    it('should allow partial updates', () => {
      expect(() => updateContactSchema.parse({ id: 'c-1', first_name: 'New Name' })).not.toThrow();
      expect(() => updateContactSchema.parse({ id: 'c-1', last_name: 'New Last' })).not.toThrow();
      expect(() => updateContactSchema.parse({ id: 'c-1', status: 'inactive' })).not.toThrow();
      expect(() => updateContactSchema.parse({
        id: 'c-1',
  ...
  describe('Error Message Formatting', () => {
    it('should provide clear error messages', async () => {
      const testCases = [
        {
          data: { first_name: '', last_name: 'Doe', email: { primary: 'test@example.com' } },
          expectedError: 'First name is required',
          field: 'first_name'
        },
        {
          data: { first_name: 'John', last_name: '', email: { primary: 'test@example.com' } },
        ...
        {
          data: { first_name: 'John', last_name: 'Doe', email: { primary: 'invalid' } },
