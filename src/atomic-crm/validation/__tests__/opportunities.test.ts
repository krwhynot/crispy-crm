...
describe("Opportunity Validation Schemas", () => {
  ...
  describe("opportunitySchema", () => {
    ...
    it("should validate amount is positive", () => {
      ...
      expect(() =>
        opportunitySchema.parse({ ...validOpportunity, amount: -0.01 }),
      ).toThrow(z.ZodError);
    });

    it("should accept both string and number IDs", () => {
      expect(() =>
        opportunitySchema.parse({ ...validOpportunity, id: "string-id" }),
      ).not.toThrow();
      expect(() =>
        opportunitySchema.parse({ ...validOpportunity, id: 12345 }),
      ).not.toThrow();
      expect(() =>
  ...
  describe("createOpportunitySchema", () => {
    ...
    it("should reject creation without required fields", () => {
      ...
      expect(() => createOpportunitySchema.parse({ name: "Test" })).toThrow(
        z.ZodError,
      );
      expect(() =>
  ...
  describe("updateOpportunitySchema", () => {
    ...
    it("should allow partial updates", () => {
      ...
      expect(() =>
        updateOpportunitySchema.parse({ id: "opp-1", amount: 5000 }),
      ).not.toThrow();
      expect(() =>
