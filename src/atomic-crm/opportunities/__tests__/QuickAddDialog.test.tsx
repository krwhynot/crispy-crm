...
describe('QuickAddDialog', () => {
  ...
  it('renders correct title and description', () => {
    ...
    expect(screen.getByText('Quickly capture lead information from trade show booth conversations')).toBeInTheDocument();
  });
  ...
  it('has proper accessibility attributes', () => {
    ...
    const description = screen.getByText('Quickly capture lead information from trade show booth conversations');
