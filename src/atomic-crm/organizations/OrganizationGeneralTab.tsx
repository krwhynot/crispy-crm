/**
 * OrganizationGeneralTab - General information tab for organization forms
 *
 * NOTE: Duplicate organization name checking is now handled as a "soft warning"
 * at the form level (OrganizationCreate.tsx) instead of as hard validation here.
 * This allows users to create organizations with similar names after confirming
 * they understand the potential duplicate.
 *
 * See: useDuplicateOrgCheck.ts and DuplicateOrgWarningDialog.tsx
 */
