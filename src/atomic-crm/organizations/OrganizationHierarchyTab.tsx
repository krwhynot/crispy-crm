  ...
  return (
    <div className="space-y-6">
      ...
      <Alert>
        ...
        <AlertDescription>
          Organizations can be structured hierarchically with parent-child relationships.
          This helps track multi-location businesses, franchise operations, and corporate structures.
        </AlertDescription>
      </Alert>
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mb-4">
          If this organization is a branch, subsidiary, or division of another organization,
          select the parent organization below.
        </p>
