...
describe('Principal Pipeline Filtering (B1)', () => {
  describe('useCurrentSale lookup logic', () => {
    it('should return salesId when user_id matches', () => {
      ...
      const matchedSale = saleRecords.find(
        (s) => s.user_id === userId
      );
    ...
    it('should return null when no sales record exists', () => {
      ...
      const matchedSale = saleRecords.find(
        (s) => s.user_id === userId || s.email === userEmail
      );
  ...
  describe('View sales_id derivation', () => {
    ...
    it('should return null when no opportunities have account_manager_id', () => {
      const opportunities = [
        { id: 1, principal_organization_id: 100, account_manager_id: null, created_at: '2025-01-01' },
        { id: 2, principal_organization_id: 100, account_manager_id: null, created_at: '2025-01-15' },
      ];
    ...
    it('should handle principals with no opportunities', () => {
      const opportunities: { principal_organization_id: number; account_manager_id: number | null }[] = [];
