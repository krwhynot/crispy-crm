...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      contacts: {
        Row: {
          ...
          sales_id: number | null
          search_tsv: unknown
          secondary_sales_id: number | null
          state: string | null
          status: string | null
          tags: number[] | null
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "contacts_secondary_sales_id_fkey"
            columns: ["secondary_sales_id"]
            isOneToOne: false
            referencedRelation: "sales"
            referencedColumns: ["id"]
          },
      ...
      organizations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "organizations_secondary_sales_id_fkey"
            columns: ["secondary_sales_id"]
            isOneToOne: false
            referencedRelation: "sales"
            referencedColumns: ["id"]
    ...
    Views: {
      ...
      contacts_with_account_manager: {
        Row: {
          ...
          sales_id: number | null
          search_tsv: unknown
          secondary_account_manager_is_user: boolean | null
          secondary_account_manager_name: string | null
          secondary_sales_id: number | null
          state: string | null
          status: string | null
          tags: number[] | null
    ...
    Functions: {
      ...
      unarchive_contact_with_relations: {
        Args: { contact_id: number }
        Returns: undefined
      }
      ...
      unarchive_organization_with_relations: {
        Args: { org_id: number }
        Returns: undefined
      }
