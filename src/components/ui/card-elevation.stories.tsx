...
export const LowElevation: Story = {
  render: () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-sm font-semibold mb-2 text-muted-foreground">Low Elevation (Default)</h3>
...
export const ElevationComparison: Story = {
  render: () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-sm font-semibold mb-2 text-muted-foreground">Elevation System Comparison</h3>
        <p className="text-xs text-muted-foreground mb-4">
      ...
      <div className="grid gap-6">
        {/* Low Elevation */}
        <div>
          <div className="text-xs font-semibold text-muted-foreground mb-2">LOW (shadow-sm → shadow-md)</div>
        ...
        <div>
          <div className="text-xs font-semibold text-muted-foreground mb-2">MEDIUM (--shadow-card-2)</div>
          <div className="rounded-lg border border-transparent bg-card px-4 py-3 transition-all duration-150 hover:border-primary shadow-[0_4px_8px_rgba(0,0,0,0.1)] hover:shadow-[0_8px_16px_rgba(0,0,0,0.15)] motion-safe:hover:-translate-y-0.5 motion-safe:hover:scale-[1.01] cursor-pointer">
            ...
            <p className="text-xs text-muted-foreground">Enhanced elevation with border color change</p>
          </div>
        </div>
...
export const Phase2ComponentPreview: Story = {
  ...
  render: () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-sm font-semibold mb-2 text-muted-foreground">Phase 2: Component Extraction</h3>
        <p className="text-xs text-muted-foreground mb-4">
