  ...
  render: () => (
    <Accordion type="single" collapsible className="w-[450px]">
      <AccordionItem value="item-1">
        ...
        <AccordionContent>
          Yes. It adheres to the WAI-ARIA design pattern, ensuring proper keyboard navigation
      ...
      <AccordionItem value="item-2">
        ...
        <AccordionContent>
          ...
          You can customize it using CSS-in-JS or traditional CSS.
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-3">
        ...
        <AccordionContent>
          ...
          The animation can be customized or disabled if needed.
        </AccordionContent>
      </AccordionItem>
    </Accordion>
  ),
    ...
    <Accordion type="multiple" defaultValue={['item-1', 'item-3']} className="w-[450px]">
      <AccordionItem value="item-1">
        ...
        <AccordionContent>
          ...
          Click on any trigger to expand or collapse its content.
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-2">
        <AccordionTrigger>Independent Items</AccordionTrigger>
        <AccordionContent>
          Each item operates independently. Opening one doesn't affect the others.
          This is useful for FAQs where users might want to see multiple answers.
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-3">
        <AccordionTrigger>Default Expanded</AccordionTrigger>
        <AccordionContent>
          This item and the first one are expanded by default using the defaultValue prop.
          You can set any combination of items to be initially open.
        </AccordionContent>
      </AccordionItem>
    </Accordion>
  ),
  ...
  render: () => (
    <Accordion type="single" collapsible defaultValue="item-2" className="w-[450px]">
      ...
      <AccordionItem value="item-2">
        ...
        <AccordionContent>
          This section is expanded by default because its value matches the defaultValue prop.
      ...
      <Accordion type="single" defaultValue="item-1" className="w-full">
        <AccordionItem value="item-1">
          ...
          <AccordionContent>
            ...
            Try clicking this trigger - it won't collapse.
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-2">
          <AccordionTrigger>Switch Between Items</AccordionTrigger>
          <AccordionContent>
            You can switch between items, but you cannot close all items.
            This ensures that some content is always visible.
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-3">
          <AccordionTrigger>Guaranteed Visibility</AccordionTrigger>
          <AccordionContent>
            This pattern is useful when you want to ensure users always see
            some information, like in stepped forms or guided tutorials.
          </AccordionContent>
        </AccordionItem>
      </Accordion>
    </div>
      ...
      <AccordionItem value="item-2">
        ...
        <AccordionContent>
          <div className="space-y-4">
            <p>
              This section contains a large amount of content to demonstrate how the
              accordion handles longer text and maintains proper spacing.
            </p>
            <p>
            ...
            <p>
              The accordion smoothly animates to accommodate content of any length,
              ensuring a pleasant user experience regardless of the amount of information.
            </p>
          </div>
        </AccordionContent>
      </AccordionItem>
      ...
      <Accordion type="single" collapsible className="w-full">
        ...
        <AccordionItem value="cancel">
          ...
          <AccordionContent>
            ...
            or cancellation fees. Your service will continue until the end of your current
            billing period.
          </AccordionContent>
        </AccordionItem>
      ...
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="item-1">
          ...
          <AccordionContent>
            <div className="space-y-2">
              <p className="text-sm">
                This accordion automatically adjusts to the available width.
                On mobile devices, the trigger text will wrap if needed.
              </p>
        ...
        <AccordionItem value="item-2">
          ...
          <AccordionContent>
            The trigger text wraps naturally while maintaining proper alignment
            with the chevron icon.
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-3">
          <AccordionTrigger>Touch-Friendly Targets</AccordionTrigger>
          <AccordionContent>
            The trigger areas are large enough for comfortable touch interaction
            on mobile devices, meeting accessibility guidelines.
          </AccordionContent>
        </AccordionItem>
      </Accordion>
    </div>
      ...
      <div className="rounded-lg border bg-background p-4">
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              The bottom border uses the semantic --border color variable,
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              Text uses --foreground for primary content and --muted-foreground
              for secondary content, maintaining proper contrast ratios.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </div>
      ...
      <div className="rounded-lg border bg-secondary p-4">
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              The accordion adapts to different background colors while
      ...
      <div className="rounded-lg border border-primary bg-primary/5 p-4">
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              Custom hover states can use semantic colors like --primary
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="item-1">
            ...
            <AccordionContent className="text-destructive/80">
              Important warnings or destructive actions can use the
              --destructive semantic color for emphasis.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </div>
